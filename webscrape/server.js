...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.theringer.com/game-of-thrones").then(function(response) {
    ...
    $(".c-compact-river__entry").each(function(i, element) {
      ...
      var url = $(this).find("noscript").text();
      result.pic = url.slice(17,url.length-2);

      console.log("title is blalll    ",result.pic);
